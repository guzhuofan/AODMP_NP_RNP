...
def dijkstra_shortest_path(graph, start_node, end_node):
    ...
    start_node: int - 起点编号（从1开始）
    end_node: int - 终点编号（从1开始）
    ...
    for u in range(num_nodes):
        for v in range(num_nodes):
            if graph[u][v] == 1:
                ...
                # 行索引对应节点：adjacency_list[u]表示图中索引为 u+1的节点,v表示图中索引为 v+1的节点
...
if __name__ == '__main__':
    ...
    print(dijkstra_shortest_path(adj_matrix, 2, 4))
